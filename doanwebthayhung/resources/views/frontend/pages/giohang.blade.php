		...
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  ...
				  <li style="float:right;"><a href="/doanwebthayhung/viewdonhang">Đặt Hàng</a></li>
									...
									<tr>
										...
										<td class="cart_quantity">
											<div class="cart_quantity_button">
												<!-- <a class="cart_quantity_up" href="/doanwebthayhung/tangsoluong/{{$ctgh->MaCTGH}}"> + </a> -->
										...
										<td class="cart_total">
											<p class="cart_total_price">
												<?php
													echo number_format($ctgh->SoLuongMua*$sp->Gia, 0) . " VNĐ";
												?> VNĐ
											</p>
										</td>
										<td class="cart_delete">
											<!-- <a class="cart_quantity_delete" href="/doanwebthayhung/xoa_sp_gh/{{$ctgh->MaCTGH}}"><i class="fa fa-times"></i></a> -->
